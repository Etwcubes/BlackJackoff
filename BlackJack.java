...
//                    convertTen(temp);
            ...
            if (dealerscore <= 16){
                ...
                dealer.addCard(mainDeck.dealCard());
                System.out.print(dealerindex + "\r\n");
                System.out.print(dealer.getCardCount() + "\r\n");
                System.out.print("Dealer your new value is " + dealer.getCard(dealerindex));
    ...
    private static void convertTen(Card myCard) {
